...
export function Markets({ items, hidden, onAdd, onDelete, onRefresh }: Props) {
  ...
  return <div className="page-stack">
    ...
    <section className="provider-strip"><div><i className="provider-dot live" /><span><strong>CoinGecko</strong><small>Keyless · crypto · 60 sec cache</small></span></div><div><i className="provider-dot live" /><span><strong>Gold API</strong><small>Keyless · metals · 5 min cache</small></span></div><div><i className="provider-dot optional" /><span><strong>Alpha Vantage</strong><small>Optional key · delayed · 25/day</small></span></div><div><i className="provider-dot manual" /><span><strong>TSETMC / Mofid</strong><small>Opt-in quote adapter · no account access</small></span></div></section>
  </div>;
}
