...
export default function StyleguidePage() {
  ...
  return <StyleguideLayout><div className="mx-auto max-w-6xl px-5 py-10 lg:px-10 lg:py-14">
    ...
    <footer className="flex items-center justify-between border-t border-border pt-7 text-[9px] text-muted-foreground"><span>Northstar design system · Estedad</span><span className="flex items-center gap-1.5"><Radio className="size-3" /> Local-first foundation</span></footer>
